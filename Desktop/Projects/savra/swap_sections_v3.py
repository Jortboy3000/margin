...
# Define markers - Update to reflect the recent rename
...
# We keep the start marker line (the wrapper div)
# We replace everything AFTER the start marker line, up to the end marker.
# Actually, let's include the start_marker in the replacement to be safe and clean.
...
# Replace content from start_idx to end_idx-1 (we want to preserve <!-- Trust Indicators -->)
# Note: end_idx points to the start of <!--
# We want to replace everything from start_idx up to end_idx.
# And add some newlines for cleanliness.
...
print(f"Swap complete. Replaced content from index {start_idx}.")
